...
class MainGrid extends React.Component{
  constructor(props){
    ...
    render() {
        var layout = [
          { i: "a", x: 0, y: 0, w: 4, h: 15, minW: 3, maxW: 7.5, maxH: 50, minH: 12 },
          { i: "b", x: 4.2, y: 0, w: 4, h: 13, minW: 2.5, maxW: 8, minH: 7, maxH: 70},
          { i: "c", x: 2, y: -.5, w: 5.5, h: 18, minW: 4.5, MaxW: 4.5, minH: 8, maxH: 70 },
        ];
        return (
          <GridLayout
            className=""
